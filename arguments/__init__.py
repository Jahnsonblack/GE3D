...
class GuidanceParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        self.jump_max_begin: 80
        self.jump_max_end: 50
        self.jump_min_begin: 60
        self.jump_min_end: 30
        self.max_step_begin: 480
        self.max_step_end: 300
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        #self.scale_up_cameras_iter = 300
...
class ReconOptimizationParams(OptimizationParams):
    def __init__(self, opts=None):
        self.iterations = 200 # 10_000
        # self.position_lr_init = 0.0008
        # self.position_lr_final = 0.0000016
        ...
        self.fovy_scale_up_factor = [0.75, 1.1]
        self.phi_scale_up_factor = 1.5
        #super().__init__(parser, "ReconOptimization Parameters")
